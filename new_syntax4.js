...
global.Object["="] = (obj, params) => { return { value: ( obj.value == params[0].value), class: "Boolean", type: TYPE.VARIABLE } };

// Numberクラス
global["Number"] = {};
//global.Number.className = "Number";
global.Number["superClass"] = global.Object;
global.Number["+"] = (obj, params) => { return { value: (obj.value + params[0].value), class: "Number", type: TYPE.VARIABLE } };
global.Number["-"] = (obj, params) => { return { value: (obj.value - params[0].value), class: "Number", type: TYPE.VARIABLE } };
global.Number["*"] = (obj, params) => { return { value: (obj.value * params[0].value), class: "Number", type: TYPE.VARIABLE } };
global.Number["/"] = (obj, params) => { return { value: (obj.value / params[0].value), class: "Number", type: TYPE.VARIABLE } };
global.Number["<"] = (obj, params) => { return { value: (obj.value < params[0].value), class: "Boolean", type: TYPE.VARIABLE } };
global.Number["<="] = (obj, params) => { return { value: (obj.value <= params[0].value), class: "Boolean", type: TYPE.VARIABLE } };
global.Number[">"] = (obj, params) => { return { value: (obj.value > params[0].value), class: "Boolean", type: TYPE.VARIABLE } };
global.Number[">="] = (obj, params) => { return { value: (obj.value >= params[0].value), class: "Boolean", type: TYPE.VARIABLE } };
